...
st.info("""
Carregue um ficheiro Excel (.xlsx) com peças ortogonais, como por exemplo, o ficheiro instâncias.xlsx
A aplicação irá decompor automaticamente cada peça em "Mãe" e "Filha(s)" e, de seguida, otimizar a sua disposição. É aconselhável começar pela folha "LI" , visto que é a menos pesada para o programa.
""")
...
# =============================================================================
# FUNÇÕES DE OTIMIZAÇÃO (Solver e pre-process)
# =============================================================================
