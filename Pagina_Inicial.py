...
st.markdown("""
Esta aplicação foi desenvolvida no âmbito do Mestrado em Engenharia e Gestão da Cadeia de Abastecimento do ISEP na UC de MOADC pelo grupo 3 contituido por Gonçalo Nunes, Gonçalo Lobo, Miguel Mexedo e Tiago Teixeira.

O objetivo é resolver problemas complexos de corte e empacotamento, minimizando o desperdício de material.

**Utilize o menu de navegação na barra lateral para selecionar o problema que deseja resolver.**
""")

st.info("Selecione uma das páginas na barra lateral para começar.")
